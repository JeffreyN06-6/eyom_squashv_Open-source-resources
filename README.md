# eyom_squashv_Open-source-resources
eyom_squashv 賬號內的開源資源
# 港式高快速路牌設計指南 (HK-Style Expressway Signage Design Guide)

這是一套參考香港道路標誌風格設計的組件庫。

**授權聲明 (Licensing)**
本作品採用 **CC BY-SA 3.0** (姓名標示-相同方式分享) 授權。
